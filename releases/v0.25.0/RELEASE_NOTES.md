...
```bash
curl -L -o tiny-brain-0.25.0.mcpb \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.25.0/tiny-brain-0.25.0.mcpb"

mcpb install tiny-brain-0.25.0.mcpb
```
...
- **Commit:** 857b68d90304ab271aae2d33d0c3bc12191fe693
