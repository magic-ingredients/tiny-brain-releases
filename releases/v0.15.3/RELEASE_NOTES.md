...
```bash
curl -L -o tiny-brain-0.15.3.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.15.3/tiny-brain-0.15.3.dxt"

dxt install tiny-brain-0.15.3.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.15.3
```
...
- **Commit:** fd4ae90028472c11ce2ea84317dfb525915bbf13
