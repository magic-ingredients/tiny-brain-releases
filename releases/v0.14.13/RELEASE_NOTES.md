...
```bash
curl -L -o tiny-brain-0.14.13.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.14.13/tiny-brain-0.14.13.dxt"

dxt install tiny-brain-0.14.13.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.14.13
```
...
- **Commit:** 92f62bb9a236b2c6bb3976d892fcb855b2181d44
