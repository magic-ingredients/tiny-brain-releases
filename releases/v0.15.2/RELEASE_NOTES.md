...
```bash
curl -L -o tiny-brain-0.15.2.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.15.2/tiny-brain-0.15.2.dxt"

dxt install tiny-brain-0.15.2.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.15.2
```
...
- **Commit:** b1c40d4e4a8c51bbf2018136d3b0b2d5cd0380ca
