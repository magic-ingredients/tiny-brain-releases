...
```bash
curl -L -o tiny-brain-0.20.0.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.20.0/tiny-brain-0.20.0.dxt"

dxt install tiny-brain-0.20.0.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.20.0
```
...
- **Commit:** 43b30b44ef872de97162f3f6b4702af68035a3ed
