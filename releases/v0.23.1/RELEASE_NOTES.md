...
```bash
curl -L -o tiny-brain-0.23.1.mcpb \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.23.1/tiny-brain-0.23.1.mcpb"

mcpb install tiny-brain-0.23.1.mcpb
```
...
- **Commit:** 479248096305c923f3af49777ff27b374c0d669f
