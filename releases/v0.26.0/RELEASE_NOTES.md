...
```bash
curl -L -o tiny-brain-0.26.0.mcpb \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.26.0/tiny-brain-0.26.0.mcpb"

mcpb install tiny-brain-0.26.0.mcpb
```
...
- **Commit:** 69ff89f34cc6bd0dffa3fb447e24dccfb0551354
