...
```bash
curl -L -o tiny-brain-0.18.1.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.18.1/tiny-brain-0.18.1.dxt"

dxt install tiny-brain-0.18.1.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.18.1
```
...
- **Commit:** 7dc0d1ef704e073ea7de918a7035d50163c71022
