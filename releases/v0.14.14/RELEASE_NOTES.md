...
```bash
curl -L -o tiny-brain-0.14.14.dxt \
  "https://github.com/magic-ingredients/tiny-brain-releases/releases/download/v0.14.14/tiny-brain-0.14.14.dxt"

dxt install tiny-brain-0.14.14.dxt
```

### Option 3: NPM Global Install
```bash
npm install -g @magic-ingredients/tiny-brain-local@0.14.14
```
...
- **Commit:** 8e41960eee10d03b894bb3a00ce456ad777ff113
