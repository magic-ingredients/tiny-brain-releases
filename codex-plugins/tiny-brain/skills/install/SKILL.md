...
1. Read all `*.md` files from `the installed Tiny Brain plugin capabilities directory (capabilities/)` (or `capabilities/` relative to working directory)
...
1. `the installed Tiny Brain plugin capabilities directory (capabilities/)<capability-id>.md` (plugin directory)
